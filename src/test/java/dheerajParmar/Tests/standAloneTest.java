...
public class standAloneTest {
	...
	public static void main(String[] args) {
		// using webdriverManager we can invoke chromdriver without having it in our
		// local
		...
		driver.findElement(By.id("userEmail")).sendKeys("dheerajparmar014@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Dheeraj@123");
